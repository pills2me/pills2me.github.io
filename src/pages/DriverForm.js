            ...
            <Jumbotron>
                ...
                <Form>
                    ...
                    <Form.Group controlId="milesTravel">
                        ...
                        <Form.Control type="text" placeholder="ex. 10 miles" />
                    </Form.Group>
                    <Form.Group controlId="availability">
                        <Form.Label>What days and times are you available?</Form.Label>
                        <Form.Control as="textarea" rows="3" placeholder="ex. Fridays 9AM-4PM" />
                    </Form.Group>
                    ...
                    <Form.Group controlId="instructionsCheck">
                        <Form.Check type="checkbox" label="Please check this box when you have read and understood our instructions." />
                    </Form.Group>
                    <Form.Group>
                    ...
                    <Form.Group controlId="instructionsCheck">
                        <Form.Check type="checkbox" label="“By submitting this form, I attest that I am at least 18 years old and below the age of 65 years and have no symptoms or risk factors of Covid-19 per the CDC guidelines. I have also read and accept the terms and conditions above.”" />
                    </Form.Group>
                    <Form.Group>
